...
class Url extends \Magento\Framework\Url
{
    ...
    {
    	//if ($this->_objectManager->get('Magento\Framework\App\State')->getAreaCode() == 'adminhtml' || !$this->_objectManager->get('Lofmp\SubDomain\Helper\Data')->isEnabled()) {
		...
		$store_id = $this->_objectManager->get('Lof\MarketPlace\Helper\Data')->getStore()->getId();
